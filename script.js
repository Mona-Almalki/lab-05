const data = [
  ...
  function populateTable(players) {
    ...
    players.forEach(player => {
      ...
      const reboundsTd = document.createElement("td");
      reboundsTd.textContent = player.rebounds;
      tr.appendChild(reboundsTd);
  ...
  function sortData(column) {
    ...
    const currentDisplayedRows = [...playerRows.querySelectorAll("tr")];
    let currentPlayers = currentDisplayedRows.map(row => {
      const cells = row.querySelectorAll("td");
      return {
        name: cells[0].textContent,
        team: cells[1].textContent,
        points: parseFloat(cells[2].textContent),
        rebounds: parseFloat(cells[3].textContent),
        assists: parseFloat(cells[4].textContent)
      };
    });
    ...
    populateTable(currentPlayers);
  }
  
  document.querySelectorAll("#player-stats thead th").forEach(th => {
